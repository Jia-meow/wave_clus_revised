...
% fname=loader(sprintf('Processed Data/Temp Data Folder/%s',handles.par.fname),1);
% fname_in=loader(sprintf('Processed Data/Temp Data Folder/%s',handles.par.fname_in),1);
